...
#This code can be imported from scramble.py and I can call the str_scramble function. 
str = ''
for i in range(len(s)):
    str += s[i][0] + s[i][1] + ' '
print(str)

#Everything is in 1 class and only this code needs to be called outside of the class. 
#Encapsulation of scramble method maybe?
#For this website, these will be called in the views.py() file. Only c.printcube(s) will be called here for testing view in terminal.
c = Cube()
c.scramble(s)
c.printcube()
